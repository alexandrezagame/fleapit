...
file74 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741381/Accessories/necklace_2_omp9lq.jpg')
...
file75 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741771/Accessories/necklace_3_tbro0w.jpg')
file76 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741771/Accessories/necklace_4_n3xj9m.jpg')
file77 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741771/Accessories/necklace_5_jdkr6y.jpg')
...
necklace2.pictures.attach(io: file76, filename: 'necklace2.jpg', content_type: 'image/jpg')
necklace2.pictures.attach(io: file77, filename: 'necklace2.jpg', content_type: 'image/jpg')
necklace2.save!

file78 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585747552/Electronics/laptop13_kfwop0.png')
file79 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585747552/Electronics/laptop14_j9up23.png')
file80 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585747552/Electronics/laptop12_rdr3il.png')
...
laptop1.pictures.attach(io: file79, filename: 'laptop1.jpg', content_type: 'image/jpg')
laptop1.pictures.attach(io: file80, filename: 'laptop1.jpg', content_type: 'image/jpg')
laptop1.save!

file81 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585745458/Electronics/laptop_sander3_jlb9ou.jpg')
file82 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585745458/Electronics/laptop_sander4_a9yi3g.jpg')
file83 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585745458/Electronics/laptop_sander5_jbv6h3.jpg')
...
laptop2.pictures.attach(io: file82, filename: 'laptop2.jpg', content_type: 'image/jpg')
laptop2.pictures.attach(io: file83, filename: 'laptop2.jpg', content_type: 'image/jpg')
laptop2.save!

file84 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585746037/Electronics/skateboard_ul7u1h.jpg')
file85 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585746037/Electronics/skateboard1_ignuv4.jpg')
...
skateboard1.pictures.attach(io: file84, filename: 'skateboard1.jpg', content_type: 'image/jpg')
skateboard1.pictures.attach(io: file85, filename: 'skateboard1.jpg', content_type: 'image/jpg')
skateboard1.save!

file86 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749406/Outdoors/tool4_ogl9rq.jpg')
file87 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749406/Outdoors/tool5_ifbnav.jpg')
...
axe1.pictures.attach(io: file86, filename: 'axe1.jpg', content_type: 'image/jpg')
axe1.pictures.attach(io: file87, filename: 'axe1.jpg', content_type: 'image/jpg')
axe1.save!

file88 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749611/Outdoors/tool6_ovwhjh.jpg')
file89 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749611/Outdoors/tool7_myvv0t.jpg')
...
throwingknives1.pictures.attach(io: file88, filename: 'throwingknives1.jpg', content_type: 'image/jpg')
throwingknives1.pictures.attach(io: file89, filename: 'throwingknives1.jpg', content_type: 'image/jpg')
