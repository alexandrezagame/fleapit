...
dress = Item.new(name: 'dress', brand: 'Reformation', description: 'The best dress in the world.', category: category2, min_price: 250, max_price: 1000, user: nina)
...
jeans = Item.new(name: 'jeans', brand: 'Reformation', description: 'Nice legs. This is a high rise, full length jean with a straight leg and a finished hem. The Cindy Bootleg is fitted throughout.', category: category2, min_price: 250, max_price: 1000, user: nina)
...
jumpsuit = Item.new(name: 'jumpsuit', brand: 'Reformation', description: 'As easy as it looks. This is a slightly cropped jumpsuit with a center front zipper, a collar and short sleeves. The Kenny is slim fitting throughout with a detached belt.', category: category2, min_price: 250, max_price: 1000, user: nina)
...
jacket1 = Item.new(name: 'Jacket', brand: 'Wood Wood', description: 'Corduroy jacket from Wood Wood. Made of 100% Cotton. Zipper closure at front. Four front pockets, two with hidden zipper closure. Buttoned cuffs', category: category3, min_price: 250, max_price: 1000, user: alex)
...
shoes1 = Item.new(name: 'Shoes', brand: 'Vans', description: '- Sneakers from VANS. Made of Fabric. Fabric interior. Rubber outsole. Rounded toe and laces at front. Suede portions', category: category3, min_price: 250, max_price: 1000, user: alex)
...
chair1 = Item.new(name: 'Linen Haverhill Chair', brand: 'Anthropologie', description: 'Reminiscent of Danish midcentury designs, this modern chair features a wide- set silhouette with tufted cushions upholstered in natural oatmeal linen. A true form-follows-function piece, tapered brass accents protect the gleaming legs while lending the piece a refined elegance.', category: category1, min_price: 250, max_price: 1000, user: alex)
...
table1 = Item.new(name: 'table', brand: 'Wood Wood', description: 'Crafted with tapered legs, curved corners, and subtle hints of brushed brass, this Mid Century-inspired piece lends a touch of casual charm to dining rooms, breakfast nooks, and eat-in kitchens alike.', category: category1, min_price: 250, max_price: 1000, user: felix)
...
sunglasses1 = Item.new(name: 'Sunglasses', brand: 'Ace and Tate', description: 'Rounded frame with keyhole bridge. Structurally crisp – a sharp new tradition. The Benjamin has character: approachable, educated, smart, offbeat..', category: category6, min_price: 250, max_price: 1000, user: felix)
...
hat1 = Item.new(name: 'Hat', brand: 'Adidas', description: 'A classic brand logo fronts this stylish street cap built from durable cotton for lasting appeal.', category: category6, min_price: 200, max_price: 300, user: felix)
...
backpack = Item.new(name: 'Backpack', brand: 'Douchebags', description: 'Your one stop shop, all in one, can’t be beaten backpack. Your ultimate friend whether you’re just going around the block or heading off for a dusk to dawn shoot.', category: category6, min_price: 250, max_price: 1000, user: daniel)
...
jeans1 = Item.new(name: 'Jeans', brand: 'Gap', description: 'High stretch. Low maintenance. Super cool. Our skinniest pair is designed to move wherever you do. This is authentic denim. Made to last. Made so you can be you. And weve been at it for almost 50 years.', category: category3, min_price: 250, max_price: 1000, user: daniel)
...
bed1 = Item.new(name: 'Bed', brand: 'Mio', description: 'Sultan Continental bed 120x200 white', category: category1, min_price: 5000, max_price: 7000, user: madeleine)
...
dress2 = Item.new(name: 'Dress', brand: 'H&M', description: 'Knee-length dress in cotton slub jersey. V-neck, butterfly sleeves, and gathered, elasticized seam at waist.', category: category2, min_price: 150, max_price: 300, user: raphaelle)
...
dress3 = Item.new(name: 'Dress', brand: 'H&M', description: 'Calf-length dress in airy, woven viscose fabric. Round neckline with decorative gathers, opening at back of neck with button, and wide, elbow-length raglan sleeves.', category: category2, min_price: 200, max_price: 350, user: raphaelle)
...
mirror1 = Item.new(name: 'Mirror', brand: 'English decorations', description: 'Fantastic wooden framed mirror with beveled glass. There are two pairs of hooks fitted to back of the mirror frame for easy fixing to the wall.', category: category1, min_price: 3000, max_price: 4500, user: raphaelle)
...
sweatshirt1 = Item.new(name: 'Printed sweatshirt', brand: 'H&M', description: 'Top in soft, printed cotton jersey with a round, ribbed neckline and long sleeves with ribbing at the cuffs.', category: category3, min_price: 150, max_price: 200, user: sander)
...
jacket1 = Item.new(name: 'Hooded jacket', brand: 'H&M', description: 'Lightweight sweatshirt jacket with a double-layered, drawstring hood. Zipper at front, side pockets, and ribbing at cuffs and hem.', category: category3, min_price: 100, max_price: 250, user: gheorghe)
...
jeans2 = Item.new(name: 'Jeans', brand: 'H&M', description: '5-pocket jeans in washed denim with a regular waist, zip fly, and slim legs.', category: category3, min_price: 200, max_price: 300, user: gheorghe)
...
mobilephone1 = Item.new(name: 'Iphone 11', brand: 'Media Markt', description: 'Open your eyes and experience the beauty of the world from a new perspective with the iPhone 11 and its 6.1 inch screen. The phone comes with a fast chip and advanced technology.', category: category5, min_price: 8000, max_price: 9000, user: nina)
...
file70 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585733869/Tools/daniel__ve3grz.jpg')
file71 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585734235/Tools/daniel_1_t8scqt.jpg')
file72 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585734235/Tools/daniel_2_fildjs.jpg')
toolset1 = Item.new(name: 'Tool set', brand: 'Crescent', description: '170 Pc. General Purpose Tool Set - Closed Case.', category: category8, min_price: 2250, max_price: 2850, user: daniel)
toolset1.pictures.attach(io: file70, filename: 'toolset1.jpg', content_type: 'image/jpg')
toolset1.pictures.attach(io: file71, filename: 'toolset1.jpg', content_type: 'image/jpg')
toolset1.pictures.attach(io: file72, filename: 'toolset1.jpg', content_type: 'image/jpg')
toolset1.save!

file73 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741381/Accessories/necklace__dcggua.jpg')
file74 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585734235/Tools/daniel_1_t8scqt.jpg')
file75 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585734235/Tools/daniel_2_fildjs.jpg')
necklace1 = Item.new(name: 'Necklace', brand: 'Dior', description: 'Color:Silver/Pink. Model:Rhinestone logo pendant. Length:40cm.', category: category4, min_price: 5500, max_price: 6500, user: madeleine)
necklace1.pictures.attach(io: file73, filename: 'necklace1.jpg', content_type: 'image/jpg')
necklace1.pictures.attach(io: file74, filename: 'necklace1.jpg', content_type: 'image/jpg')
necklace1.pictures.attach(io: file75, filename: 'necklace1.jpg', content_type: 'image/jpg')
necklace1.save!

file73 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741771/Accessories/necklace_3_tbro0w.jpg')
file74 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741771/Accessories/necklace_4_n3xj9m.jpg')
file75 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585741771/Accessories/necklace_5_jdkr6y.jpg')
necklace2 = Item.new(name: 'Necklace', brand: 'Versace', description: 'Drawing from the House rich heritage, this gold-tone necklace feature a GV monogram pendant and a Medusa charm. All Versace Jewelry products are lead and nickel free. All materials are hypoallergenic.', category: category4, min_price: 3500, max_price: 4500, user: gheorghe)
necklace2.pictures.attach(io: file73, filename: 'necklace2.jpg', content_type: 'image/jpg')
necklace2.pictures.attach(io: file74, filename: 'necklace2.jpg', content_type: 'image/jpg')
necklace2.pictures.attach(io: file75, filename: 'necklace2.jpg', content_type: 'image/jpg')
necklace2.save!

file76 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585747552/Electronics/laptop13_kfwop0.png')
file77 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585747552/Electronics/laptop14_j9up23.png')
file78 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585747552/Electronics/laptop12_rdr3il.png')
laptop1 = Item.new(name: 'Gaming laptop', brand: 'Razer', description: 'We’re pushing the limits to what a gaming laptop can do. The Razer Blade Pro 17 is built with a powerful processor to run performance-demanding AAA games on the go. We’ve made it nearly 25% smaller than its predecessor, with a faster 17.3” display that’s fitted into a body as sleek and compact as a 15” laptop.', category: category5, min_price: 29500, max_price: 33500, user: daniel)
laptop1.pictures.attach(io: file76, filename: 'laptop1.jpg', content_type: 'image/jpg')
laptop1.pictures.attach(io: file77, filename: 'laptop1.jpg', content_type: 'image/jpg')
laptop1.pictures.attach(io: file78, filename: 'laptop1.jpg', content_type: 'image/jpg')
laptop1.save!

file79 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585745458/Electronics/laptop_sander3_jlb9ou.jpg')
file80 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585745458/Electronics/laptop_sander4_a9yi3g.jpg')
file81 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585745458/Electronics/laptop_sander5_jbv6h3.jpg')
laptop2 = Item.new(name: 'Laptop', brand: 'Macbook', description: 'We’re pushing the limits to what a gaming laptop can do. The Razer Blade Pro 17 is built with a powerful processor to run performance-demanding AAA games on the go. We’ve made it nearly 25% smaller than its predecessor, with a faster 17.3” display that’s fitted into a body as sleek and compact as a 15” laptop.', category: category5, min_price: 17500, max_price: 19000, user: sander)
laptop2.pictures.attach(io: file79, filename: 'laptop2.jpg', content_type: 'image/jpg')
laptop2.pictures.attach(io: file80, filename: 'laptop2.jpg', content_type: 'image/jpg')
laptop2.pictures.attach(io: file81, filename: 'laptop2.jpg', content_type: 'image/jpg')
laptop2.save!

file82 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585746037/Electronics/skateboard_ul7u1h.jpg')
file83 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585746037/Electronics/skateboard1_ignuv4.jpg')
skateboard1 = Item.new(name: 'Skate board', brand: 'SKATEDELUXE', description: 'width: 7.5", length: 32", wheelbase: 14", nose: 7.125", tail: 6.625".', category: category7, min_price: 2000, max_price: 2200, user: alex)
skateboard1.pictures.attach(io: file82, filename: 'skateboard1.jpg', content_type: 'image/jpg')
skateboard1.pictures.attach(io: file83, filename: 'skateboard1.jpg', content_type: 'image/jpg')
skateboard1.save!

file84 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749406/Outdoors/tool4_ogl9rq.jpg')
file85 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749406/Outdoors/tool5_ifbnav.jpg')
axe1 = Item.new(name: 'Axe', brand: 'Hultafors', description: 'Hultafors Hultan hatchet is a perfect outdoor companion, wether you are hiking in the wild or just need to work on the camp fire.', category: category8, min_price: 1200, max_price: 1600, user: felix)
axe1.pictures.attach(io: file84, filename: 'axe1.jpg', content_type: 'image/jpg')
axe1.pictures.attach(io: file85, filename: 'axe1.jpg', content_type: 'image/jpg')
axe1.save!

file86 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749611/Outdoors/tool6_ovwhjh.jpg')
file87 = URI.open('https://res.cloudinary.com/dgfsnlcab/image/upload/v1585749611/Outdoors/tool7_myvv0t.jpg')
throwingknives1 = Item.new(name: 'Throwing knives', brand: 'United Cutlery', description: 'Offering a compact size and discreet carry options, the Undercover Kunai Throwing Knife Set is easy to conceal and offers powerful personal protection that won’t let you down!', category: category8, min_price: 200, max_price: 250, user: raphaelle)
throwingknives1.pictures.attach(io: file86, filename: 'throwingknives1.jpg', content_type: 'image/jpg')
throwingknives1.pictures.attach(io: file87, filename: 'throwingknives1.jpg', content_type: 'image/jpg')
throwingknives1.save!
